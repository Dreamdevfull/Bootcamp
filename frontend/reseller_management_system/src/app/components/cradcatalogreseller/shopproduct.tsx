...
//   data: ShopProductsType[]
//   loading: boolean
// }

// const ShopProductsCard = ({ data, loading }: ShopProducts ) => {
...
//                 <img src={item.product.image_url} alt={item.product.name} className="w-full h-50 object-cover rounded-lg mb-3" />
//               ) : (
...
//                 <p className="text-[#1a6b5a] text-[20px] pr-3">฿{item.selling_price}</p>
//               </div>
//               {/* <div className='text-[#888780] text-[15px]'>{item.description}</div> */}
//               <div className='flex justify-between mt-2'>
//                 <div className='text-[#888780] text-[15px]'>เหลือ {item.product.stock}</div>
//               </div>
//               <div className='flex gap-2'>
//                 <EditShopProductButton id={item.id} onSuccess={() => {}}/>
//                 <RemoveShopProductButton id={item.id} onSuccess={() => {}} />
//               </div>
//             </div>
//           ))}
//         </div>
