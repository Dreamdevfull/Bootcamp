...
export function Pagination<TData>({ table, totalItems, pageSize, onPageSizeChange, currentPage }: PaginationProps<TData>) {
  const pageCount = table.getPageCount()

  // ใช้ currentPage จาก prop ไม่ใช่จาก table.getState()
