...
const FromRegister = () => {
  ...
  const classNameinput = `
    flex h-10 w-full rounded-md border-2 text-gray-800 dark:text-gray-100
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <div>
          ...
          />
          {emailError && (
            <p id="email-error" role="alert" className="text-red-500 dark:text-red-400 text-xs mt-1 font-medium">
              ⚠ {emailError}
            </p>
          )}
        </div>
        ...
        <div>
          ...
          />
          {phoneError && (
            <p id="phone-error" role="alert" className="text-red-500 dark:text-red-400 text-xs mt-1 font-medium">
              ⚠ {phoneError}
            </p>
          )}
        </div>
        ...
        <div className="flex gap-3">
          <div className="flex-1">
            ...
            />
            {passwordError && (
              <p id="password-error" role="alert" className="text-red-500 dark:text-red-400 text-xs mt-1 font-medium">
                ⚠ {passwordError}
              </p>
            )}
          </div>
          <div className="flex-1">
            ...
            />
            {confirmError && (
              <p id="confirm-error" role="alert" className="text-red-500 dark:text-red-400 text-xs mt-1 font-medium">
                ⚠ {confirmError}
              </p>
            )}
          </div>
