...
type PopCustomersOrderCompletedProps = {
  open: boolean
  onClose: () => void
}

export default function PopCustomersOrderCompleted({ open, onClose, }: PopCustomersOrderCompletedProps) {
  if (!open) return null
    ...
    >
      ...
      >
        ...
        <div className="flex justify-between">
          <h2 className="text-[22px] font-bold text-gray-800 mt-2">เพิ่มสินค้าใหม่</h2>
          <button
            onClick={onClose}
